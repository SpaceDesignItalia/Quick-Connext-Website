          ...
          <div className="min-w-[680px]">
                  ...
                  <motion.span
                    ...
                    animate={{
                      boxShadow: [
                        ...
                        "0 0 24px 2px rgba(0,196,204,0.55)",
                        "0 0 0px 0px rgba(0,196,204,0.0)",
                      ],
                    }}
            ...
            <div className="relative mt-1.5 h-3">
              <svg
                ...
                aria-hidden
              >
                <line x1="0" y1="50" x2="100" y2="50" stroke="rgba(0,196,204,0.22)" strokeWidth="3" />
                <line
                  x1="0"
                  y1="50"
                  x2="100"
              ...
              {booted && (
                <motion.span
                  ...
                  aria-hidden
                  className="absolute top-1/2 size-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand-teal-light shadow-[0_0_10px_2px_rgba(51,217,224,0.8)]"
                  ...
                  >
                    ...
                    <div
                      className={cn(
                        ...
                        isFocus
                          ? "border-brand-bright/70 bg-brand-bright/[0.14] shadow-[0_0_22px_-4px_rgba(0,196,204,0.7)] scale-[1.05]"
            ...
            <div className="relative mt-1.5 h-2">
              <svg
                ...
                aria-hidden
              >
                <line x1="0" y1="50" x2="100" y2="50" stroke="rgba(0,196,204,0.18)" strokeWidth="2.5" />
                <line
                  x1="0"
                  y1="50"
                  x2="100"
                  y2="50"
                  stroke="rgba(0,196,204,0.5)"
                  strokeWidth="2.5"
                  strokeDasharray="3 7"
                  className={booted ? "trace-march" : undefined}
                />
