      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="pt-10 text-xs text-slate-500 font-sans text-center leading-relaxed">
          <p>
            ...
            <span className="text-slate-700">|</span> Sede Legale: Via Plava 62,
            10135 Torino (Italy) <span className="text-slate-700">|</span>{" "}
            <a
              href="tel:+390110360421"
            ...
            <span className="text-slate-700">|</span> Sedi Operative: Torino -
            Genova - Roma - Palermo <span className="text-slate-700">|</span>{" "}
            <a
              href="mailto:company@piusviluppo.it"
              className="hover:text-white transition-colors"
            >
              company@piusviluppo.it
            </a>{" "}
            <span className="text-slate-700">|</span> P.Iva 12028010010{" "}
            <span className="text-slate-700">|</span> Capitale Sociale €
            89.000,00 inter. ver. <span className="text-slate-700">|</span>{" "}
            <Link
              href="/privacy-policy"
              className="hover:text-white transition-colors"
            >
