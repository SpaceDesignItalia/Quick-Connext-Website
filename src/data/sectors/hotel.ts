...
export const hotelSectorConfig: SectorConfig = {
  ...
  grid: {
    ...
    subtitle:
      "Grazie all'integrazione digitale, i sistemi domotici — BACS, Building Automation & Control System — mettono sotto controllo decine di stanze, impianti, consumi e richieste degli ospiti da un'unica piattaforma. Il clima si regola in base alla presenza, le luci si spengono quando la camera è vuota e il fermo impianti si riduce fino all'80% grazie al controllo da remoto.",
    features: [
      {
        icon: Thermometer,
  ...
  finance: {
    ...
    text: "Identifichiamo e gestiamo internamente l'accesso a tutti i finanziamenti disponibili. Ogni investimento può beneficiare di contributi a fondo perduto, crediti d'imposta e finanziamenti agevolati che, se gestiti correttamente, possono essere cumulabili. Gestiamo bandi e crediti d'imposta: Industria 4.0 e 5.0, bandi MIMIT, fondi ZES e POR, Conto Termico 3.0, bandi SIMEST e INVITALIA. Sfruttando il modello Esco, finanziamo direttamente progetti di efficientamento energetico ad alto valore per l'azienda. Costruiamo soluzioni Esco su misura, garantendo la copertura dell'investimento e un piano di rientro calibrato sui reali risparmi energetici generati.",
    points: [
  ...
  assistance: [
    {
      ...
      desc: "Assistenza strutturata 24/7 con numero dedicato. Solo prodotti di primari marchi internazionali.",
    },
    {
      icon: Timer,
      title: "Intervento in 24 ore",
      desc: "Intervento on-site in 24 h. Controllo da remoto di ogni singolo componente degli impianti.",
    },
    {
      icon: BadgeCheck,
      title: "Garanzia 24 mesi",
      desc: "Garanzia estesa di serie 24 mesi* (*rispetto a quanto previsto dalla legge).",
    },
    {
      icon: HardHat,
      title: "Installazione completa",
      desc: "Personale interno su tutte le fasi: progettazione, installazione HW, configurazione SW, cablaggio e primo avviamento.",
    },
    {
      icon: MapPin,
      title: "Copertura nazionale",
      desc: "Manutenzione su tutto il territorio nazionale.",
    },
    {
      icon: Plug,
      title: "Plug & play",
      desc: "Aggiunta nuovi device autonoma (plug and play). Nessun vincolo: qualsiasi installatore può manutenere il sistema.",
    },
    {
      icon: ShieldCheck,
      title: "Certificazioni",
      desc: "ISO 27001 · ISO 27017 · ISO 27018 · Cyber Security · Conformità BACS · Classe B",
    },
  ],
  ctaLabel: "Contattaci",
