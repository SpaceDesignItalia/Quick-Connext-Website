...
export const hotelSectorConfig: SectorConfig = {
  ...
  scenes: [
    {
      ...
      bullets: [
        "Supervisione — dashboard centralizzata, controllo da remoto e API verso ERP, PMS e BMS",
        "Integrazione — KNX, Modbus e BACnet dialogano in un'unica logica",
        "Campo — clima, luci, accessi, presenza e sicurezza di marchi primari",
        "Continuità — funzionamento garantito anche senza rete, con alimentazione di backup",
        "Zero lock-in — piattaforma aperta, cambi fornitore quando vuoi",
        "Plug & Play — aggiungi dispositivi in autonomia, con qualunque marchio compatibile",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Check-in / check-out — attivazione e disattivazione automatica della camera",
        "Lettore accessi — personalizzabile in colori, logo e finiture su misura",
        "Tasca camera — porta badge che attiva l'energia della stanza",
        "Badge — emissione e gestione credenziali ospite e staff",
        "Sensori di presenza — rilevamento occupazione integrato",
        "Profilo ospite — preferenze di temperatura e illuminazione memorizzate",
        "Non disturbare / Riordino — gestiti in automatico",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Clima HVAC — per singola camera, con sensori di presenza e occupazione",
        "Regolazione — temperatura, umidità e ventilazione in automatico",
        "Illuminazione — scenari personalizzabili: relax, lavoro, notte",
        "Tende motorizzate — integrate con luce naturale e orari",
        "Profilo ospite — temperatura e luci preferite memorizzate e riproposte",
        "Camera vuota — riduzione automatica dei consumi",
    ...
    },
    {
      ...
      bullets: [
        ...
        "Pannello di controllo — plancia unica per supervisionare tutta la struttura",
    ...
    },
    {
      ...
      bullets: [
        "Illuminazione — scenari programmabili per orario ed evento",
        "Piscina — temperatura, pH e cloro tenuti in automatico",
        "Climatizzazione — separata per ogni area funzionale dell'hotel",
        "Qualità dell'aria — ricambio a norma in base alle presenze",
        "Comfort costante 24/7 in ogni area",
      ],
    ...
    },
    {
      ...
      bullets: [
        "Dashboard — consumi elettrici, termici e idrici in tempo reale",
        "Analisi — per zona, piano o singola camera, per scovare gli sprechi",
        "Blocco senza badge — risparmio automatico a camera libera",
        "Picchi & rinnovabili — gestione dei carichi e integrazione con le fonti rinnovabili",
    ...
    },
    {
      ...
      bullets: [
        "Monitoraggio continuo — ogni componente degli impianti sotto controllo",
        "Allarmi in tempo reale — inviati al responsabile tecnico",
        "Analisi predittiva — guasti previsti prima che impattino sugli ospiti",
        "Storico & pianificazione — interventi tracciati e manutenzione programmata",
        "Diagnostica proattiva — meno fermi impianto",
  ...
  statsSection: {
    ...
    title: "Un investimento che si misura.",
    subtitle:
      "Quattro motivi concreti, ognuno con il suo numero: efficienza, ospitalità, sicurezza e redditività.",
  },
  stats: [
  ...
  statGroups: [
    {
      ...
      desc: "Il clima segue la presenza e le luci si spengono nelle stanze vuote: a camera libera i consumi si azzerano.",
      secondary: { value: "+2", label: "classi APE: salto di classe energetica" },
    },
    {
      icon: Users,
      title: "Ospitalità",
      stat: { value: "+30%", label: "soddisfazione ospite" },
      desc: "Comfort costante e personalizzato, con le preferenze di ogni ospite memorizzate: più recensioni positive e clienti che tornano.",
    },
    {
      icon: ShieldCheck,
      title: "Sicurezza",
      stat: { value: "−60%", label: "incidenti e criticità" },
      desc: "Telecamere, allarmi e antincendio in un'unica supervisione; la diagnostica risolve i guasti prima che diventino disservizi.",
      secondary: { value: "−45%", label: "guasti grazie alla manutenzione preventiva" },
    },
    {
      icon: TrendingUp,
      title: "Redditività",
      stat: { value: "+15%", label: "valore dell'immobile" },
      desc: "L'investimento si ripaga con i risparmi energetici realmente generati, e l'edificio è già conforme alle nuove normative.",
